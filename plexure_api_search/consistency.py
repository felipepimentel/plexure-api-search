...
class ProjectHealth:
    ...
    def __init__(self, cache_file: str = ".health/consistency.json"):
    ...
    def check_cache_consistency(self) -> Dict[str, Any]:
        ...
        """
        cache_paths = [
            ".cache/search_history.json",
            ".metrics/search_quality.json",
            ".health/consistency.json"
        ]
    ...
    def get_health_summary(self) -> Dict[str, str]:
        ...
        return {
            "status": "healthy" if all([deps_ok, models_ok, cache_ok, api_ok]) else "unhealthy",
